...
**Hub learnings:** At session close, capture any voice/style/method/system learnings from this session and write them to `_hub-context.md` under `## Learnings for Hub`. The `/close` skill Step 5a handles this. TDG-Intel reads this section and promotes confirmed patterns to permanent memory.
